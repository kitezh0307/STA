...
class Language_model (nn.Module):
    def __init__(self, args, use_PLM = True):
        ...
        if use_PLM:
            ...
            self.tokenizer = AutoTokenizer.from_pretrained(pretrained_model, trust_remote_code=True, padding_side='left')
    ...
    def forward(self, fusion_embedding, labels):
        ...
        with torch.amp.autocast(device_type='cuda'):
            output = self.model(input_ids=opt_tokens, input_fusion=fusion_embedding, labels=labels)
