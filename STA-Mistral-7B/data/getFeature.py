...
def parse_args():
    ...
    parser.add_argument('--data_dir', type=str, default='CH-SIMS',
                        help='path to CH-SIMS')
    parser.add_argument('--openface2Path', type=str, default="FeatureExtraction",
                        help='path to FeatureExtraction tool in openface2')
    parser.add_argument('--pretrainedBertPath', type=str, default="/bert/chinese_L-12_H-768_A-12",
